...
SUBROUTINE env_tg_cft3s( f, dfft, isgn )
  ...
  USE env_scatter_mod,ONLY : env_fft_scatter_xy, env_fft_scatter_yz, env_fft_scatter_tg
  USE env_scatter_mod,ONLY : env_fft_scatter_tg_opt
  ...
  if (abs(isgn) == 1 ) then       ! potential fft
     ...
     CALL env_fftx_error__( ' tg_cft3s', ' wrong value of isgn ', 10+abs(isgn) )
  end if
  ALLOCATE( aux( nnr_ ) ) 
  !
  IF ( isgn > 0 ) THEN  ! G -> R
...
!
  ...
  IF ( i <= 0 .OR. i > dfft%nr1 ) CALL env_fftx_error__( ' get_f_of_R', ' first  index out of range ', 1 )
  IF ( j <= 0 .OR. j > dfft%nr2 ) CALL env_fftx_error__( ' get_f_of_R', ' second index out of range ', 2 )
  IF ( k <= 0 .OR. k > dfft%nr3 ) CALL env_fftx_error__( ' get_f_of_R', ' third  index out of range ', 3 )
...
!
  ...
  IF ( i <= 0 .OR. i > dfft%nr1 ) CALL env_fftx_error__( ' put_f_of_R', ' first  index out of range ', 1 )
  IF ( j <= 0 .OR. j > dfft%nr2 ) CALL env_fftx_error__( ' put_f_of_R', ' second index out of range ', 2 )
  IF ( k <= 0 .OR. k > dfft%nr3 ) CALL env_fftx_error__( ' put_f_of_R', ' third  index out of range ', 3 )
...
!
  ...
  IF ( i <= 0 .OR. i > dfft%nr1 ) CALL env_fftx_error__( ' get_f_of_G', ' first  index out of range ', 1 )
  IF ( j <= 0 .OR. j > dfft%nr2 ) CALL env_fftx_error__( ' get_f_of_G', ' second index out of range ', 2 )
  IF ( k <= 0 .OR. k > dfft%nr3 ) CALL env_fftx_error__( ' get_f_of_G', ' third  index out of range ', 3 )
...
!
  ...
  IF ( i <= 0 .OR. i > dfft%nr1 ) CALL env_fftx_error__( ' put_f_of_G', ' first  index out of range ', 1 )
  IF ( j <= 0 .OR. j > dfft%nr2 ) CALL env_fftx_error__( ' put_f_of_G', ' second index out of range ', 2 )
  IF ( k <= 0 .OR. k > dfft%nr3 ) CALL env_fftx_error__( ' put_f_of_G', ' third  index out of range ', 3 )
