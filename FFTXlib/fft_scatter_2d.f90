...
!
!-----------------------------------------------------------------------
SUBROUTINE env_fft_scatter ( dfft, f_in, nr3x, nxx_, f_aux, ncp_, npp_, isgn )
  !-----------------------------------------------------------------------
  !
...
END SUBROUTINE env_fft_scatter
!
!=----------------------------------------------------------------------=!
   END MODULE env_fft_scatter_2d
!=----------------------------------------------------------------------=!
