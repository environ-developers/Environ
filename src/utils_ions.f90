...
CONTAINS
    ...
    FUNCTION get_atmnum(label)
        !wgt  FUNCTION get_atmwgt(label) #TODO
        !
        ...
        !
        get_atmnum = num
        !    get_atmwgt=weigth #TODO
        !
        !--------------------------------------------------------------------------------
    END FUNCTION get_atmnum
    !wgt  END FUNCTION get_atmwgt #TODO
    !------------------------------------------------------------------------------------
    !>
    !! #TODO replace with simplified version
    !!
    !------------------------------------------------------------------------------------
