...
MODULE utils_functions
    ...
    PUBLIC :: create_environ_functions, destroy_environ_functions, &
              copy_environ_functions, density_of_functions, gradient_of_functions, &
              laplacian_of_functions, hessian_of_functions!, derivative_of_functions #TODO field-aware
    !
    ...
    !
    ! INTERFACE derivative_of_functions ! #TODO field-aware
