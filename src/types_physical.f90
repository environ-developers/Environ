...
MODULE types_physical
    ...
    !
    PRIVATE :: DP, environ_cell, core_container, environ_density, environ_gradient, &
               environ_hessian, environ_functions
    !
    !------------------------------------------------------------------------------------
END MODULE types_physical
!----------------------------------------------------------------------------------------
