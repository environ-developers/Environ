...
grep -A 14 'image.*energy' H2+H.out | tail -15 >> results.txt
...
grep -A 14 'image.*energy' H2+H_pressure.out | tail -15 >> results.txt
...
grep -A 14 'image.*energy' H2+H_dielectric.out | tail -15 >> results.txt
